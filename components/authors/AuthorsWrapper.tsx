...
const mockAuthors: Author[] = [
  ...
  },
  {
    id: "2",
    name: "George Orwell",
    biography: "Eric Blair, known by his pen name George Orwell, was an English novelist and essayist.",
    birthYear: 1903,
    nationality: "British",
  ...
  },
  {
    ...
    biography: "Francis Scott Key Fitzgerald was an American novelist and short story writer.",
    birthYear: 1896,
    nationality: "American",
    genres: ["Classic Literature", "Modernist"],
    bookCount: 3,
    availableBooks: 2,
    popularWorks: ["The Great Gatsby", "Tender Is the Night", "This Side of Paradise"],
  ...
  },
  {
    ...
    biography: "Sir William Gerald Golding was a British novelist and playwright.",
    birthYear: 1911,
    nationality: "British",
  ...
  },
  {
    ...
    biography: "Dame Agatha Mary Clarissa Christie was an English writer known for her detective novels.",
    birthYear: 1890,
    nationality: "British",
    genres: ["Mystery", "Crime", "Detective Fiction"],
    bookCount: 12,
    availableBooks: 8,
    popularWorks: ["Murder on the Orient Express", "The Murder of Roger Ackroyd", "And Then There Were None"],
    awards: ["Grand Master Award", "Order of the British Empire"]
  },
  {
    id: "8",
    name: "Mark Twain",
    biography: "Samuel Langhorne Clemens, known by his pen name Mark Twain, was an American writer and humorist.",
    birthYear: 1835,
    nationality: "American",
    genres: ["Adventure", "Satire", "American Literature"],
    bookCount: 5,
    availableBooks: 4,
    popularWorks: ["The Adventures of Tom Sawyer", "Adventures of Huckleberry Finn", "The Prince and the Pauper"],
    awards: ["American Academy of Arts and Letters"]
  }
];
...
const AuthorsWrapper: FC = () => {
  ...
  const totalAvailable = authors.reduce((sum, author) => sum + author.availableBooks, 0);
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                {author.awards.length > 0 && (
                  <div className="space-y-2">
                    <div className="text-sm font-medium text-foreground">Awards:</div>
                    <div className="space-y-1">
        ...
        <div className="mt-12 text-center animate-fade-in">
          <div className="bg-gradient-secondary p-8 rounded-lg text-white">
            ...
            <p className="mb-4 opacity-90">
              Don't see your favorite author? Let us know who you'd like to see in our collection
            </p>
