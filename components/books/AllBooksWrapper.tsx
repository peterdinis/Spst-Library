      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          ...
          <Badge 
            ...
            className={book.available ? "bg-green-100 text-green-800 border-green-200" : "bg-amber-100 text-amber-800 border-amber-200"}
          >
...
const mockBooks = [
  ...
  },
  {
      ...
      available: true,
      coverImage: "/placeholder.jpg",
      description: "The story of Captain Ahab's obsessive quest for revenge against a white whale."
  },
  {
      id: "11",
      title: "War and Peace",
  ...
  },
  {
      ...
      dueDate: "2024-02-05",
      coverImage: "/placeholder.jpg",
      description: "A novel about the mental anguish and moral dilemmas of a young man who commits murder."
  }
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <div className="bg-white dark:bg-background rounded-lg p-3 shadow-sm border">
                                <div className="text-sm text-gray-500 dark:text-sky-100">Total Books</div>
                                <div className="text-xl font-bold text-primary">{books.length}</div>
                            </div>
                            <div className="bg-white dark:bg-background rounded-lg p-3 shadow-sm border">
                                <div className="text-sm text-gray-500 dark:text-sky-100">Available</div>
                                <div className="text-xl font-bold text-green-600">{availableCount}</div>
                            </div>
                            <div className="bg-white dark:bg-background rounded-lg p-3 shadow-sm border">
                                <div className="text-sm text-gray-500 dark:text-sky-100">Borrowed</div>
                    ...
                    <div className="bg-white dark:bg-stone-950 p-6 rounded-xl shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                            ...
                            <div className="lg:col-span-2">
                                <label htmlFor="search" className="text-sm font-medium text-gray-700 dark:text-sky-100 mb-1 block">Search</label>
                            ...
                            {/* Category Filter */}
                            <div>
                                <label htmlFor="category" className="text-sm font-medium text-gray-700 dark:text-sky-100 mb-1 block">Category</label>
                            ...
                            {/* Availability Filter */}
                            <div>
                                <label htmlFor="availability" className="text-sm font-medium text-gray-700 dark:text-sky-100 mb-1 block">Availability</label>
                            ...
                            {/* Sort Filter */}
                            <div>
                                <label htmlFor="sort" className="text-sm font-medium text-gray-700 dark:text-sky-100 mb-1 block">Sort By</label>
                ...
                <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <p className="text-gray-500">
                        Showing <span className="font-semibold">{startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredBooks.length)}</span> of <span className="font-semibold">{filteredBooks.length}</span> books
                    </p>
                ...
                {paginatedBooks.length > 0 ? (
                    ...
                    <div className="text-center py-16 animate-fade-in bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-500 max-w-md mx-auto">
                            Try adjusting your search or filters. We couldn't find any books matching your criteria.
                        </p>
                        <Button 
                            onClick={clearFilters}
                            variant="outline" 
