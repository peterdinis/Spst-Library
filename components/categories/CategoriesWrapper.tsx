...
import { BookOpen, Users, TrendingUp, ChevronLeft, ChevronRight, Search } from "lucide-react";
...
const mockCategories: Category[] = [
  {
    ...
    description: "Timeless works that have shaped literature and continue to influence readers today.",
    bookCount: 45,
    availableCount: 32,
    popularBooks: ["To Kill a Mockingbird", "The Great Gatsby", "Pride and Prejudice"],
  ...
  },
  {
    ...
    description: "Explore futuristic worlds, advanced technology, and imaginative stories.",
    bookCount: 38,
    availableCount: 25,
  ...
  },
  {
    ...
    bookCount: 41,
    availableCount: 29,
    popularBooks: ["Gone Girl", "The Girl with the Dragon Tattoo", "Sherlock Holmes"],
  ...
  },
  {
    ...
    description: "True stories of remarkable people and significant historical events.",
    bookCount: 33,
    availableCount: 27,
  ...
  },
  {
    id: "6",
    name: "Young Adult",
    description: "Coming-of-age stories and adventures perfect for teenage readers.",
    bookCount: 47,
    availableCount: 35,
    popularBooks: ["The Hunger Games", "Harry Potter", "The Fault in Our Stars"],
  ...
  },
  {
    id: "7",
    name: "Adventure",
    description: "Thrilling journeys and exciting escapades across different worlds.",
    bookCount: 29,
    availableCount: 23,
    popularBooks: ["Lord of the Flies", "Robinson Crusoe", "The Adventures of Tom Sawyer"],
  ...
  },
  {
    ...
    bookCount: 56,
    availableCount: 42,
    popularBooks: ["The Lord of the Rings", "Harry Potter", "A Game of Thrones"],
  ...
  },
  {
    ...
    bookCount: 39,
    availableCount: 31,
    popularBooks: ["A Brief History of Time", "The Innovators", "The Code Book"],
  ...
  },
  {
    id: "12",
    name: "Cooking & Food",
    description: "Delicious recipes and culinary adventures from around the world.",
    bookCount: 34,
    availableCount: 29,
    popularBooks: ["Salt, Fat, Acid, Heat", "The Joy of Cooking", "Mastering the Art of French Cooking"],
    color: "bg-amber-100 text-amber-700 border-amber-200",
    icon: "🍳"
  }
];
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h1 className="text-3xl font-bold text-foreground mb-2">Book Categories</h1>
                ...
                <Card className="h-full hover-lift shadow-card group overflow-hidden">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="text-sm font-medium text-foreground">Popular Books:</div>
