...
const BookForm: FC<BookFormProps> = ({ initialData, onSubmit, onCancel, isLoading = false }) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>{initialData?.id ? 'Upraviť knihu' : 'Pridať novú knihu'}</CardTitle>
                <CardDescription>
                    {initialData?.id ? 'Upravte informácie o knihe' : 'Vyplňte informácie o novej knihe'}
                </CardDescription>
            </CardHeader>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            />
                            {errors.totalCopies && (
                                <p className="text-sm text-red-600">{errors.totalCopies.message}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.availableCopies && (
                                <p className="text-sm text-red-600">{errors.availableCopies.message}</p>
                            )}
                        </div>
                    </div>
