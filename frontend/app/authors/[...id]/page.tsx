                            ...
                            <CardContent className="p-6 space-y-4">
                                ...
                                {author.birthDate && (
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                        ...
                                        <span>
                                            Narodený: {new Date(author.birthDate).toLocaleDateString('sk-SK', {
                                                year: 'numeric',
                                                month: 'long',
                                                day: 'numeric',
                                            })}
                                ...
                                <div className="pt-4 border-t">
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-muted-foreground">Počet kníh</span>
                                                            ...
                                                            <div className="flex-1">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <Badge variant={book.availableCopies > 0 ? "success" : "destructive"}>
                                                                        {book.availableCopies > 0 ? 'Dostupné' : 'Nedostupné'}
                                                                    </Badge>
                                                                </div>
                                                            </div>
                                                        </div>
