...
const Hero = dynamic(() => import("@/components/home/Hero"), {
  loading: () => <div className="h-[600px] animate-pulse bg-gray-200 dark:bg-gray-800" />,
  ...
  loading: () => (
    <div className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-64 animate-pulse bg-gray-200 dark:bg-gray-800 rounded-lg" />
        ))}
      </div>
    </div>
  ),
...
const Homepage: NextPage = () => {
  return (
    <>
      <Suspense fallback={<div className="h-[600px] animate-pulse bg-gray-200 dark:bg-gray-800" />}>
        <Hero />
      </Suspense>
      <Services />
      <Footer />
