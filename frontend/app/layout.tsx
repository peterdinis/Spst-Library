...
export const metadata: Metadata = {
  ...
  description: "Digitálny katalóg školských knižníc - vyhľadávanie kníh, autorov, rezervácie a správa čitateľských kont",
  keywords: [
    "školská knižnica",
    "digitálna knižnica",
    "knižný katalóg",
  ...
  authors: [
    { name: "Školská knižnica" },
    { name: "Vzdelávacia inštitúcia" }
  ],
