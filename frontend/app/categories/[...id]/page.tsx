                    ...
                    <Card className="shadow-lg">
                        <CardHeader>
                            <div className="flex items-start justify-between">
                                <div>
                                    <CardTitle className="text-4xl mb-2">{category.name}</CardTitle>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                <div className="text-center p-4 bg-muted/50 rounded-lg">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">Celkom kníh</p>
                                </div>
                                <div className="text-center p-4 bg-muted/50 rounded-lg">
                                    <p className="text-3xl font-bold text-green-600">{stats.available}</p>
                                    <p className="text-sm text-muted-foreground mt-1">Dostupných</p>
                                </div>
                                <div className="text-center p-4 bg-muted/50 rounded-lg">
                                    <p className="text-3xl font-bold text-orange-600">{stats.total - stats.available}</p>
                                    <p className="text-sm text-muted-foreground mt-1">Vypožičaných</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
