...
import { mockBooksCrudApi, mockAuthorsCrudApi, mockCategoriesCrudApi } from '@/lib/crudApi';
import BookForm from '@/components/admin/BookForm';
import AuthorForm from '@/components/admin/AuthorForm';
import CategoryForm from '@/components/admin/CategoryForm';
import { BookFormData, AuthorFormData, CategoryFormData } from '@/lib/validations';
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            >
                ...
                <p className="text-muted-foreground">Spravujte knihy, autorov a kategórie</p>
            </motion.div>
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm mt-2 line-clamp-2">{author.biography}</p>
                                            </div>
                                            <div className="flex gap-2">
                                                <Button
                                                    size="sm"
