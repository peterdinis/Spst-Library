...
export const authorSchema = z.object({
	name: z
		.string()
		.min(2, "Meno autora je povinné")
		.max(100, "Meno je príliš dlhé"),
	biography: z
		.string()
		.min(10, "Biografia musí mať aspoň 10 znakov")
		.max(2000, "Biografia je príliš dlhá"),
	birthDate: z.string().optional().or(z.literal("")),
	nationality: z
		.string()
		.min(2, "Národnosť je povinná")
		.max(50, "Národnosť je príliš dlhá")
		.optional()
		.or(z.literal("")),
...
export const categorySchema = z.object({
	name: z
		.string()
		.min(2, "Názov kategórie je povinný")
