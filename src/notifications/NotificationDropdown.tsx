...
const NotificationItem = ({ notification, onMarkAsRead, onDelete }: NotificationItemProps) => {
  ...
  return (
    <div className={cn(
      ...
      !isRead ? "bg-white dark:bg-gray-900" : "bg-gray-50/50 dark:bg-gray-900/50",
      notification.priority === 'high' && "border-red-200 dark:border-red-900/30",
      notification.priority === 'medium' && "border-amber-200 dark:border-amber-900/30",
            ...
            >
              <TabsList className="grid grid-cols-4 w-full h-9">
                <TabsTrigger value="all" className="text-xs">
                  Všetky
                  <Badge variant="secondary" className="ml-1.5 h-5 w-5 p-0 text-[10px]">
                ...
                <TabsTrigger value="unread" className="text-xs">
                  Neprečítané
                  {unreadCount > 0 && (
                    <Badge variant="default" className="ml-1.5 h-5 w-5 p-0 text-[10px] bg-blue-500">
                      {unreadCount}
                    </Badge>
                  )}
                </TabsTrigger>
                <TabsTrigger value="high" className="text-xs">
                  Vysoká
                  {highPriorityCount > 0 && (
                    <Badge variant="destructive" className="ml-1.5 h-5 w-5 p-0 text-[10px]">
                      {highPriorityCount}
                    </Badge>
                  )}
                </TabsTrigger>
            ...
            {showSettings ? (
              <ScrollArea className="h-[400px]">
                <div className="p-4 space-y-6">
                  ...
                  <Separator />
                  <div className="space-y-3">
                    {['borrow_due', 'fine_issued', 'membership_expiry', 'reservation_ready', 'promotional'].map((type) => (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h4 className="font-semibold text-lg mb-2">Žiadne notifikácie</h4>
