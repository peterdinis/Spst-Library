...
import {
  BookOpen, Calendar, Clock, Eye, RefreshCw, AlertTriangle,
  Search, Heart, MoreVertical, Award, Timer, Star,
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <Avatar className="w-24 h-24 border-2 border-slate-700">
                ...
                <AvatarFallback className="text-3xl bg-slate-800 text-slate-300">JN</AvatarFallback>
              </Avatar>
              
              <div className="flex-1 space-y-3">
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-slate-100 mb-2">{userProfile.name}</h1>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className="bg-slate-800 text-slate-300 border-slate-700 px-3 py-1">
                    Členstvo od {new Date(userProfile.memberSince).getFullYear()}
                  </Badge>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-8 border-t border-slate-800">
              <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-slate-800">
                <div className="text-3xl font-bold text-slate-100 mb-1">{userProfile.totalBooksRead}</div>
              ...
              <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-slate-800">
                <div className="text-3xl font-bold text-slate-100 mb-1">{userProfile.currentStreak}</div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="bg-slate-900 border-slate-800">
                ...
                <CardContent>
                  <div className="text-4xl font-bold text-slate-100 mb-2">{userProfile.currentStreak}</div>
                ...
                {books.filter(b => b.status === "active").slice(0, 3).map((book) => (
                  <div key={book.id} className="flex items-center gap-4 p-4 bg-slate-800/50 rounded-xl border border-slate-800 hover:border-indigo-600 transition-all group">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-slate-200 truncate mb-1">{book.title}</h4>
                      <p className="text-sm text-slate-400 truncate mb-2">{book.author}</p>
                      <Progress value={book.progress} className="h-2 bg-slate-700" />
                    </div>
                    <div className="text-right flex-shrink-0">
                      <div className="text-2xl font-bold text-indigo-400">{book.progress}%</div>
                      <div className="text-xs text-slate-500">{book.daysRemaining} dní</div>
                    </div>
                  </div>
                ))}
              </CardContent>
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="flex-1 p-6">
                        <div className="space-y-5">
                          <div>
                            <h3 className="text-2xl font-bold text-slate-100 mb-1">{book.title}</h3>
                            {book.subtitle && (
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                            <div className="space-y-3">
                              <div className="flex items-center justify-between text-sm">
                                <span className="text-slate-400">Požičané:</span>
                                <span className="text-slate-200 font-medium">
                                  {new Date(book.borrowedDate).toLocaleDateString('sk')}
                                </span>
                              </div>
                              <div className="flex items-center justify-between text-sm">
                                <span className="text-slate-400">Splatnosť:</span>
                                <span className={`font-medium ${book.isOverdue ? 'text-red-400' : 'text-slate-200'}`}>
                                  {new Date(book.dueDate).toLocaleDateString('sk')}
                                </span>
                              </div>
                              {book.fineAmount > 0 && (
                                <div className="flex items-center justify-between text-sm p-3 bg-red-900/20 rounded-lg border border-red-800/50">
                                  <span className="text-red-400">Pokuta:</span>
                                  <span className="font-bold text-red-400">€{book.fineAmount.toFixed(2)}</span>
                                </div>
                              )}
                            </div>
                            ...
                            <div className="space-y-3">
                              <div>
                                <div className="flex justify-between text-sm mb-2">
                                  <span className="text-slate-400">Pokrok</span>
                                  <span className="text-slate-200 font-medium">{book.progress}%</span>
                                </div>
                                <Progress value={book.progress} className="h-2 bg-slate-800" />
                              </div>
                              <div>
                                <div className="flex justify-between text-sm mb-2">
                                  <span className="text-slate-400">Obnovenia</span>
                                  <span className="text-slate-200 font-medium">{book.renewalsLeft} / 3</span>
                                </div>
                                <Progress value={(book.renewalsLeft / 3) * 100} className="h-2 bg-slate-800" />
                              </div>
                            </div>
                          </div>
              ...
              <Card className="bg-slate-900 border-slate-800">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-slate-800">
                    ...
                    <span className="text-2xl font-bold text-slate-100">14 dní</span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    ...
                    <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-slate-800">
                      ...
                      <div className="text-lg font-bold text-slate-100">{userProfile.currentStreak}</div>
