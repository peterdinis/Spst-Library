export const mockAuthors = [
	{
		id: "1",
		name: "J.K. Rowling",
		bio: "Britská autorka známa sériou o Harrym Potterovi.",
	},
	{
		id: "2",
		name: "J.R.R. Tolkien",
		bio: "Anglický spisovateľ, autor Pána prsteňov.",
	},
	{
		id: "3",
		name: "George R.R. Martin",
		bio: "Americký autor série Pieseň ľadu a ohňa.",
	},
];
...
export const mockBooks = [
	{
		...
		description:
			"Prvý diel populárnej série o mladom čarodejníkovi, ktorý objaví svoj skutočný pôvod.",
		coverUrl:
			"https://images.unsplash.com/photo-1626618011154-1b5e1b2138eb?q=80&w=400&auto=format&fit=crop",
	...
	},
	{
		...
		description:
			"Epický fantasy príbeh o ceste za zničením Vládnuceho prsteňa.",
		coverUrl:
	...
	},
	{
		...
		title: "Hra o tróny",
		description:
			"Zápas vznešených rodín o Železný trón na kontinente Westeros.",
		coverUrl:
