...
const BookCard = ({ book, onAction }: BookCardProps) => {
  ...
  const getStatusText = () => {
    ...
    if (book.status === "active") return `${book.daysRemaining} dní do splatnosti`;
    return "Vrátené";
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {format(new Date(book.borrowedDate), "d. MMM yyyy", { locale: sk })}
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={cn(
                      ...
                      {format(new Date(book.dueDate), "d. MMM yyyy", { locale: sk })}
                    </span>
                  </div>
                  {book.fineAmount > 0 && (
                    <div className="flex items-center justify-between text-sm">
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-muted-foreground">Pokrok čítania</span>
...
const ReadingStats = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg font-semibold">Štatistiky čítania</CardTitle>
...
const EmptyState = ({ activeTab, searchQuery, onClearSearch }: {
  activeTab: string;
  searchQuery: string;
  onClearSearch: () => void;
}) => {
    ...
    <Card className="text-center">
      <CardContent className="py-12">
        ...
        <h3 className="text-lg font-semibold mb-2">
          {activeTab === "overdue" && !searchQuery ? "Žiadne omeškané knihy!" : "Žiadne knihy"}
        </h3>
...
function BorrowedBooksPage() {
  ...
  const { data: books = mockBorrowedBooks, isLoading, error } = useQuery({
    ...
    return (
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">Chyba pri načítaní kníh</h3>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Spravujte svoje požičané knihy, sledujte splatnosti a objavujte nové čítanie
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={renewAll} disabled={filteredBooks.length === 0}>
