  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <motion.div variants={itemVariants as unknown as Variants} className="mb-6">
          <Button
            variant="ghost"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <motion.div variants={itemVariants as unknown as Variants} className="lg:col-span-2 space-y-6">
