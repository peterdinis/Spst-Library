    ...
    <div className="relative flex flex-col items-center justify-center min-h-[90vh] px-4 overflow-hidden bg-background">
      ...
      <div className="max-w-2xl w-full text-center space-y-8 relative z-10">
        <div className="space-y-4">
          ...
          >
            Ospravedlňujeme sa, ale pri spracovaní vašej požiadavky došlo k neočakávanej chybe v knižničnom systéme.
          </motion.p>
        </div>
        ...
        >
          ...
          >
            ...
            {showDetails ? "Skryť technické detaily" : "Zobraziť technické detaily"}
            {showDetails ? (
              ...
              >
                <div className="relative bg-card border rounded-2xl p-6 text-left shadow-inner group/details">
                  ...
                  <div className="space-y-4 font-mono text-xs md:text-sm">
                    <div>
                      <span className="text-destructive font-bold uppercase tracking-wider text-[10px]">Chybová správa</span>
                      <p className="mt-1 text-foreground/90 break-words">{error.message || "Neznáma chyba"}</p>
                    </div>
                    {error.digest && (
                      <div>
                        <span className="text-primary font-bold uppercase tracking-wider text-[10px]">ID Chyby (Digest)</span>
                        <p className="mt-1 text-foreground/90">{error.digest}</p>
                      </div>
                    )}
                    <div className="opacity-50 group-hover/details:opacity-100 transition-opacity">
                      <span className="font-bold uppercase tracking-wider text-[10px]">Stack Trace</span>
