...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
      ...
      >
        <h2 className="text-3xl font-extrabold tracking-tight">Kniha nebola nájdená</h2>
        <p className="text-lg text-slate-500 font-medium">
          Stránka, ktorú hľadáte, v našom archíve neexistuje alebo bola presunutá do iného regálu.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
          <Link href="/books">
            <Button size="lg" className="rounded-full px-8 h-14 font-bold shadow-xl shadow-primary/20 w-full">
              <Search className="mr-2 h-5 w-5" />
              Prehľadať katalóg
            </Button>
          </Link>
          <Link href="/">
            <Button size="lg" variant="outline" className="rounded-full px-8 h-14 font-bold border-2 w-full">
