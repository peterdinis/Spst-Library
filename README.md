...
- **Tanstack Start** – A React framework for building server-rendered and statically generated web applications.
- **WorkOS** – Handles secure authentication and user session management.
